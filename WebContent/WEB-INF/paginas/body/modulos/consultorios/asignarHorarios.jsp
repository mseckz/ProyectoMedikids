					...
					<s:form theme="bootstrap" action="agregarMedicoHorario" namespace="/consultorios" cssClass="form-horizontal">
						<div class="row">
							<div class="col-md-5">
								...
								<s:select list="turnos" name="horario.turno.id" key="horario.label.turno" 
											listKey="id" listValue="descripcion" emptyOption="true"/>
						
								<s:select list="medicos" name="horario.medico.id" key="horario.label.medico"
											listKey="id" listValue="nombreCompleto" emptyOption="true" id="medicosselect"/>
		        ...
		        if(td.childNodes[i].nodeType == 1) {
		            if(td.childNodes[i].nodeName == "INPUT") {
		                if(td.childNodes[i].checked) {
		                    ...
		                    td.style.backgroundColor = "#47A7FF";
		                }
		            } else {
